...
namespace SistemaCompra.API.Produto
{
    public class ProdutoController : ControllerBase
    {
        ...
        {
            return StatusCode(_mediator.Send(registrarProdutoCommand).GetAwaiter().GetResult() ? 201 : 400);
        }
        ...
        {
            return StatusCode(_mediator.Send(atualizarPrecoCommand).GetAwaiter().GetResult() ? 200 : 400);
        }
    }
}
